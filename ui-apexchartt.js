...
var barOptions = {
  series: [
    {
      name: "Suhu",
      data: [28, 27, 37, 33, 31, 32, 39, 36, 38],
    },
    {
      name: "Kelembaban",
      data: [26, 24, 31, 28, 24, 25, 30, 29, 30],
    },
    {
      name: "Soil Moisture",
      data: [103, 111, 108, 101, 92, 95, 107, 110, 100],
    },
  ],
  chart: {
    type: "bar",
  ...
  xaxis: {
    categories: ["UID 1", "UID 2", "UID 3", "UID 4", "UID 5", "UID 6", "UID 7", "UID 8", "UID 9"],
  },
  // yaxis: {
  //   title: {
  //     text: "$ (thousands)",
 ...
 var areaOptions = {
   ...
   xaxis: {
     ...
     categories: [
       ...
       "2018-12-08T01:30:00.000Z",
       "2018-12-09T02:30:00.000Z",
       "2018-12-10T03:30:00.000Z",
       "2018-12-11T04:30:00.000Z",
       "2018-12-12T05:30:00.000Z",
       "2018-12-13T06:30:00.000Z",
     ],
   },
   tooltip: {
     x: {
